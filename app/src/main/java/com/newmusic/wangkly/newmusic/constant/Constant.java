package com.newmusic.wangkly.newmusic.constant;
...
public class Constant {
    ...
    public static final String REFRESH_PALYINGINFO ="refresh_playing_info";

    //本地音乐切换
    public static final String CHANGE_MUSIC_LOCAL ="change_music_local";
